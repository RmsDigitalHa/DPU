...
taliseRxGainTable_t rxGainTable [62] = {
	...
	{0, 0, 0, 190, 0},    /* Gain index 253 */	//-0.5dB
	{0, 0, 0, 200, 0},    /* Gain index 252 */	//0dB
	{0, 0, 0, 210, 0},    /* Gain index 251 */	//0.5dB
	{0, 0, 0, 220, 0},    /* Gain index 250 */	//1.0dB
	{0, 0, 0, 230, 0},    /* Gain index 249 */	//
	{0, 0, 0, 240, 0},    /* Gain index 248 */	//
	{0, 0, 0, 250, 0},   /* Gain index 247 */	//
	{0, 0, 0, 260, 0},   /* Gain index 246 */	//
	{0, 0, 0, 270, 0},   /* Gain index 245 */	//
	{0, 0, 0, 280, 0},   /* Gain index 244 */	//
	{0, 0, 0, 290, 0},   /* Gain index 243 */	//
	{0, 0, 0, 230, 0},   /* Gain index 242 */	//
	{0, 0, 0, 300, 0},   /* Gain index 241 */	//
	{0, 0, 0, 310, 0},   /* Gain index 240 */
	{0, 0, 0, 320, 0},   /* Gain index 239 */
	{0, 0, 0, 330, 0},   /* Gain index 238 */
	{0, 0, 0, 340, 0},   /* Gain index 237 */
	{0, 0, 0, 350, 0},   /* Gain index 236 */
	{0, 0, 0, 360, 0},   /* Gain index 235 */
	{0, 0, 0, 370, 0},   /* Gain index 234 */
	{0, 0, 0, 380, 0},   /* Gain index 233 */
	{0, 0, 0, 390, 0},   /* Gain index 232 */
	{0, 0, 0, 400, 0},   /* Gain index 231 */
	{0, 0, 0, 410, 0},   /* Gain index 230 */
	{0, 0, 0, 420, 0},   /* Gain index 229 */
	{0, 0, 0, 430, 0},   /* Gain index 228 */
